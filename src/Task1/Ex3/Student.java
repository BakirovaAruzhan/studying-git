...
public class Student {
    ...
    public static class Main2 {
        public static void main(String[] args) {
            ...
            scanner.nextLine();
            Task1.Ex2.Student[] students = new Task1.Ex2.Student[numberOfStudents];
            ...
            for (int i = 0; i < numberOfStudents; i++) {
                ...
                students[i] = new Task1.Ex2.Student(name, Mark_math, Mark_english, Mark_programming);


            }
            for (Task1.Ex2.Student student : students) {
