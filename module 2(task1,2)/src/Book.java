...
public class Book {
    ...
    public static void main(String[] args) {
        Book[] books = {
                new Book("Simple Book", "J.K. Rowling", 15000, "Simple"),
                new Book("Classical Book", "Suzanne Collins", 40000, "Classical"),
                new Book("Bestseller Book", "SenLinYu", 50000.0, "Bestseller")
        };
        ...
        books[0].setName("Updated Simple Book");
